!(function(e, t) {
  ...
  var Z = {
    ...
    ge = function(e, t) {
      for (var n = we(t), r = C.f, o = x.f, i = 0; i < n.length; i++) {
        var a = n[i];
        S(e, a) || r(e, a, o(t, a));
      }
    },
    ...
    Pe = L('wks'),
    Ce = function(e) {
      return Pe[e] || (Pe[e] = (xe && Ie[e]) || (xe ? Ie : z)('Symbol.' + e));
    },
    Ue = Ce('match'),
    De = function(e) {
      if (
  ...
  var St = function(e, t, n, r) {
    ...
    Pt = Ce('iterator'),
    Ct = function(e) {
      if (null != e) return e[Pt] || e['@@iterator'] || dt[It(e)];
    },
    Ut = Ce('iterator'),
    Dt = !1;
  try {
      ...
      for (
        var n = sn.call(cn(this), e, t),
          r = (function(e, t) {
            var n,
              r = I(e).constructor;
            return void 0 === r || null == (n = I(r)[an]) ? t : ze(n);
  ...
  var Dn = { timeoutInSeconds: 60 },
    ...
    qn = function() {
      var e =
        ...
        t = '';
      return (
        Array.from(Vn().getRandomValues(new Uint8Array(43))).forEach(function(
          n
        ) {
